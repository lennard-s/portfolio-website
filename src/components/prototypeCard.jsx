...
export default function PrototypeCard({ title, description, figmaEmbedCode, youtubeEmbedCode, objectives, learningOutcomes, skillsApplied }) {
    ...
    return (
        <Paper sx={{
            ...
            <Box sx={{ position: 'relative', width: '100%', paddingBottom: '56.25%', mb: 1 }}>
                ...
                {showDetails && (
                    <Box sx={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', overflowY: 'auto', p: 2 }}>
