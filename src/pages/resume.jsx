...
import { Typography, Box, Divider, Paper, Fade } from "@mui/material";
    ...
    <Fade in={show} timeout={500}>
      ...
      >
        ...
        <Box sx={{ marginBottom: 3 }}>
          ...
          <Typography variant="body2" sx={{ color: "#777", marginBottom: 1 }}>
            React, Figma, Python, Swift, Java, JavaScript, HTML/CSS, Docker,
            Adobe Suite, Git, MySQL, Node.js, Material-UI
          </Typography>
          <Typography
            variant="body1"
            sx={{ fontWeight: "medium", color: "#444", marginBottom: 0.5 }}
          ...
          <Typography variant="body2" sx={{ color: "#777" }}>
            ...
            & Design, Accessibility-Focused Design, Agile Methodologies,
            Waterfall Methodologies, Team Leadership, Technical Presentation,
            Public Speaking
          </Typography>
        </Box>
